...
EasyCategory("shipments", "Medical", DefaultCategoryColor)
...
EasyCategory("shipments", "Government Issue Supplies", DefaultCategoryColor)
EasyCategory("shipments", "Vapes", DefaultCategoryColor)
EasyCategory("shipments", "Toys", DefaultCategoryColor)
